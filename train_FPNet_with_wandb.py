...
train_loader = DataLoader(train_data, batch_size=1, shuffle=True)  # 批大小
valid_loader = DataLoader(val_data, batch_size=1, shuffle=False)  # 批大小
test_loader = DataLoader(test_data, batch_size=1, shuffle=False)  # 批大小
